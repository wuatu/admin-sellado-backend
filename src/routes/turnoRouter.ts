...
class TurnoRoutes{
    ...
    config(){
        ...
        this.router.get('/turno_id/:fk_calibrador',turnoController.getOneSinId);
        this.router.put('/turno/:id',turnoController.update);
        this.router.put('/turno/:fecha_termino/:hora_termino/:fk_calibrador',turnoController.closeTurnCollaborators);
