...
class MonitoreoSistemaRoutes{
    ...
    config(){
        this.router.get('/monitoreo_sistema_list/:id_linea/:id_calibrador/:id_turno/:nombre_linea', monitoreoSistemaController.list);
        this.router.get('/monitoreo_sistema_collaborators/:id_linea/:id_calibrador/:id_turno/:nombre_linea', monitoreoSistemaController.getCollaboratorsInLine);
