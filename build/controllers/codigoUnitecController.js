...
class CodigoUnitecController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let registrosDev;
                registrosDev = yield database_1.default.query('SELECT * FROM codigo_unitec ORDER BY id DESC LIMIT 100');
    ...
    searchCodeBox(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let cajas;
                cajas = yield database_1.default.query('SELECT * FROM codigo_unitec WHERE cod_caja = ? ', [code]);
                if (cajas.length > 0) {
