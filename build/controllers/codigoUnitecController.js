...
class CodigoUnitecController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let registrosDev;
                registrosDev = yield database_1.default.query('SELECT DISTINCT AS cod_caja, Codigo_Confection_Unitec AS codigo_confection, Confection_Unitec AS confection, Codigo_Embalaje_Unitec AS codigo_embalaje, Embalaje_Unitec AS embalaje, Codigo_Envase_Unitec AS codigo_envase, Envase_Unitec AS envase, Categoria_Unitec AS categoria, Categoria_Timbrada_Unitec AS categoria_timbrada  FROM registro_diario_caja_sellada ORDER BY id DESC');
    ...
    searchCodeBox(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let cajas;
                cajas = yield database_1.default.query('SELECT DISTINCT AS cod_caja, Codigo_Confection_Unitec AS codigo_confection, Confection_Unitec AS confection, Codigo_Embalaje_Unitec AS codigo_embalaje, Embalaje_Unitec AS embalaje, Codigo_Envase_Unitec AS codigo_envase, Envase_Unitec AS envase, Categoria_Unitec AS categoria, Categoria_Timbrada_Unitec AS categoria_timbrada FROM registro_diario_caja_sellada WHERE Cod_Caja_Unitec = ? ', [code]);
                if (cajas.length > 0) {
