...
class MonitoreoCalibradoresRoutes {
    ...
    config() {
        this.router.get('/monitoreo_calibrador_produccion_turno/:date/:time/:id_caliper/:option/:fecha_actual/', monitoreoCalibradoresController_1.monitoreoCalibradoresController.countBoxBycaliper);
        ...
        this.router.get('/monitoreo_calibrador_production_line/:id_caliper/:id_line/:name_line/:date/:time/:option/:fecha_actual/', monitoreoCalibradoresController_1.monitoreoCalibradoresController.getProductionLineTurno);
