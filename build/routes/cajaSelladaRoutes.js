...
class CajaSelladaRoutes {
    ...
    config() {
        ...
        this.router.get('/caja_sellada_search_line_caliper/:criterionSearch/:toSearch/:fromDateSearch/:toDateSearch/:idLine/:idCaliper', cajaSelladaController_1.cajaSelladaController.searchLineAndCaliper);
        this.router.get('/caja_sellada_count_box/:criterionSearch/:toSearch/:fromDateSearch/:toDateSearch/:idLine/:idCaliper', cajaSelladaController_1.cajaSelladaController.countBoxUnique);
