...
class MonitoreoSistemaRoutes {
    ...
    config() {
        ...
        this.router.get('/monitoreo_sistema_collaborators/:id_linea/:id_calibrador/:nombre_linea', monitoreoSistema_controllers_1.monitoreoSistemaController.getCollaboratorsInLine);
